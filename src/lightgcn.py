...
class LightGCN(torch.nn.Module):
    ...
    **recommendation** (via
    ...
    def get_embedding(self, edge_index: Adj, edge_weight: OptTensor) -> Tensor:
    ...
    def forward(self, edge_index: Adj,
        ...
        Args:
            :param edge_index: (Tensor or SparseTensor) Edge tensor specifying the
                connectivity of the graph.
            :param edge_label_index: (Tensor, optional) Edge tensor specifying the
                node pairs for which to compute rankings or probabilities.
                If :obj:`edge_label_index` is set to :obj:`None`, all edges in
                :obj:`edge_index` will be used instead. (default: :obj:`None`)
            :param edge_weight: (Tensor, optional)
        """
